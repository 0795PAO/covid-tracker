...
const Prevent = () => {
  return (
    <>
        <div className="spread-wrapper padding-100 bg-light">
            <div className="container">
                <div className="row justify-content-center">
                    <div className="col-xl-8">
                        <div className="section-title text-center">
                            <h5 className="has-animation" data-delay="0">Prevent</h5>
                ...
                <div class="row">
                    ...
                    <div className="col-sm-6 mt-5 mb-3">
                        <div className="spread-div has-animation" data-delay="150">
                            <div class="spread-image">
                                <div className="r-hex">
                                    <div className="r-hex-inner">
                                        ::before
                    ...
                    <div className="col-sm-6 mt-5">
                        <div className="spread-div has-animation" data-delay="200">
                    ...
                    <div className="col-sm-6 mt-5 mb-3">
                        <div className="spread-div has-animation" data-delay="250">
                            <div className="spread-image">
                                <div className="r-hex">
                                    <div className="r-hex-inner">
                                        ::before
                            ...
                            <div className="spread-content">
                                <h4 className="mb-3">Wear a Facemask</h4>
